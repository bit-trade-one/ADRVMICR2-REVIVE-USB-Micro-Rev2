# 1 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c" 2
# 24 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c"
...
# 24 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\stdbool.h" 1 3
# 25 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c" 2
...
# 26 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c" 2
# 87 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c"
_Bool BUTTON_IsPressed(BUTTON button)
{
    ...
    {
        case BUTTON_SC:
            return ( (PORTCbits.RC0 == 0) ? 1 : 0);
        case BUTTON_SCS:
            return ( (PORTBbits.RB4 == 0) ? 1 : 0);
        case BUTTON_SD:
            return ( (PORTCbits.RC1 == 0) ? 1 : 0);
        case BUTTON_SDS:
            return ( (PORTBbits.RB5 == 0) ? 1 : 0);
        case BUTTON_SE:
            return ( (PORTCbits.RC2 == 0) ? 1 : 0);
        case BUTTON_SF:
            return ( (PORTCbits.RC3 == 0) ? 1 : 0);
        case BUTTON_SFS:
            return ( (PORTBbits.RB6 == 0) ? 1 : 0);
        case BUTTON_SG:
            return ( (PORTCbits.RC4 == 0) ? 1 : 0);
        case BUTTON_SGS:
            return ( (PORTBbits.RB7 == 0) ? 1 : 0);
        case BUTTON_SA:
            return ( (PORTCbits.RC5 == 0) ? 1 : 0);
        case BUTTON_SAS:
            return ( (PORTAbits.RA3 == 0) ? 1 : 0);
        case BUTTON_SB:
            return ( (PORTCbits.RC6 == 0) ? 1 : 0);
        case BUTTON_SC2:
            return ( (PORTCbits.RC7 == 0) ? 1 : 0);
    }

    return 0;
}
# 139 "../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c"
void BUTTON_Enable(BUTTON button)
{
